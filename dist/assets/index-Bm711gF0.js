...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:hn,depthTest:!1,depthWrite:!1})}function ao(){return new nt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Er(),fragmentShader:`
		...
		`,blending:hn,depthTest:!1,depthWrite:!1})}function oo(){return new nt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Er(),fragmentShader:`
...
`)}const kh={[Fo]:"Linear",[No]:"Reinhard",[zo]:"Cineon",[Oo]:"ACESFilmic",[Vo]:"AgX",[Go]:"Neutral",[Bo]:"Custom"};function Hh(i,e){const t=kh[e];return t===void 0?(Ce("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const or=new F;function Wh(){Ge.getLuminanceCoefficients(or);const i=or.x.toFixed(4),e=or.y.toFixed(4),t=or.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
}`,bp=[new F(1,0,0),new F(-1,0,0),new F(0,1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1)],Tp=[new F(0,-1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1),new F(0,-1,0),new F(0,-1,0)],To=new rt,Ei=new F,rs=new F;function wp(i,e,t){let n=new ac;const r=new Oe,s=new Oe,a=new ct,o=new Bl,l=new Vl,c={},d=t.maxTextureSize,f={[Rn]:Rt,[Rt]:Rn,[dn]:dn},h=new nt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Oe},radius:{value:4}},vertexShader:yp,fragmentShader:Ep}),g=h.clone();g.defines.HORIZONTAL_PASS=1;const _=new Vt;_.setAttribute("position",new Yt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new Kt(_,h),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=cr;let u=this.type;this.render=function(A,C,z){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||A.length===0)return;A.type===Ac&&(Ce("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),A.type=cr);const S=i.getRenderTarget(),M=i.getActiveCubeFace(),D=i.getActiveMipmapLevel(),G=i.state;G.setBlending(hn),G.buffers.depth.getReversed()===!0?G.buffers.color.setClear(0,0,0,0):G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);const V=u!==this.type;V&&C.traverse(function(Y){Y.material&&(Array.isArray(Y.material)?Y.material.forEach(X=>X.needsUpdate=!0):Y.material.needsUpdate=!0)});for(let Y=0,X=A.length;Y<X;Y++){const H=A[Y],B=H.shadow;if(B===void 0){Ce("WebGLShadowMap:",H,"has no shadow.");continue}if(B.autoUpdate===!1&&B.needsUpdate===!1)continue;r.copy(B.mapSize);const $=B.getFrameExtents();if(r.multiply($),s.copy(B.mapSize),(r.x>d||r.y>d)&&(r.x>d&&(s.x=Math.floor(d/$.x),r.x=s.x*$.x,B.mapSize.x=s.x),r.y>d&&(s.y=Math.floor(d/$.y),r.y=s.y*$.y,B.mapSize.y=s.y)),B.map===null||V===!0){if(B.map!==null&&(B.map.depthTexture!==null&&(B.map.depthTexture.dispose(),B.map.depthTexture=null),B.map.dispose()),this.type===bi){if(H.isPointLight){Ce("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}B.map=new tn(r.x,r.y,{format:di,type:_n,minFilter:St,magFilter:St,generateMipmaps:!1}),B.map.texture.name=H.name+".shadowMap",B.map.depthTexture=new Pi(r.x,r.y,Jt),B.map.depthTexture.name=H.name+".shadowMapDepth",B.map.depthTexture.format=vn,B.map.depthTexture.compareFunction=null,B.map.depthTexture.minFilter=_t,B.map.depthTexture.magFilter=_t}else{H.isPointLight?(B.map=new sc(r.x),B.map.depthTexture=new zl(r.x,nn)):(B.map=new tn(r.x,r.y),B.map.depthTexture=new Pi(r.x,r.y,nn)),B.map.depthTexture.name=H.name+".shadowMap",B.map.depthTexture.format=vn;const ae=i.state.buffers.depth.getReversed();this.type===cr?(B.map.depthTexture.compareFunction=ae?fa:da,B.map.depthTexture.minFilter=St,B.map.depthTexture.magFilter=St):(B.map.depthTexture.compareFunction=null,B.map.depthTexture.minFilter=_t,B.map.depthTexture.magFilter=_t)}B.camera.updateProjectionMatrix()}const ue=B.map.isWebGLCubeRenderTarget?6:1;for(let ae=0;ae<ue;ae++){if(B.map.isWebGLCubeRenderTarget)i.setRenderTarget(B.map,ae),i.clear();else{ae===0&&(i.setRenderTarget(B.map),i.clear());const de=B.getViewport(ae);a.set(s.x*de.x,s.y*de.y,s.x*de.z,s.y*de.w),G.viewport(a)}if(H.isPointLight){const de=B.camera,Fe=B.matrix,Le=H.distance||de.far;Le!==de.far&&(de.far=Le,de.updateProjectionMatrix()),Ei.setFromMatrixPosition(H.matrixWorld),de.position.copy(Ei),rs.copy(de.position),rs.add(bp[ae]),de.up.copy(Tp[ae]),de.lookAt(rs),de.updateMatrixWorld(),Fe.makeTranslation(-Ei.x,-Ei.y,-Ei.z),To.multiplyMatrices(de.projectionMatrix,de.matrixWorldInverse),B._frustum.setFromProjectionMatrix(To,de.coordinateSystem,de.reversedDepth)}else B.updateMatrices(H);n=B.getFrustum(),b(C,z,B.camera,H,this.type)}B.isPointLightShadow!==!0&&this.type===bi&&E(B,z),B.needsUpdate=!1}u=this.type,p.needsUpdate=!1,i.setRenderTarget(S,M,D)};function E(A,C){const z=e.update(x);h.defines.VSM_SAMPLES!==A.blurSamples&&(h.defines.VSM_SAMPLES=A.blurSamples,g.defines.VSM_SAMPLES=A.blurSamples,h.needsUpdate=!0,g.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new tn(r.x,r.y,{format:di,type:_n})),h.uniforms.shadow_pass.value=A.map.depthTexture,h.uniforms.resolution.value=A.mapSize,h.uniforms.radius.value=A.radius,i.setRenderTarget(A.mapPass),i.clear(),i.renderBufferDirect(C,null,z,h,x,null),g.uniforms.shadow_pass.value=A.mapPass.texture,g.uniforms.resolution.value=A.mapSize,g.uniforms.radius.value=A.radius,i.setRenderTarget(A.map),i.clear(),i.renderBufferDirect(C,null,z,g,x,null)}function T(A,C,z,S){let M=null;const D=z.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(D!==void 0)M=D;else if(M=z.isPointLight===!0?l:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const G=M.uuid,V=C.uuid;let Y=c[G];Y===void 0&&(Y={},c[G]=Y);let X=Y[V];X===void 0&&(X=M.clone(),Y[V]=X,C.addEventListener("dispose",w)),M=X}if(M.visible=C.visible,M.wireframe=C.wireframe,S===bi?M.side=C.shadowSide!==null?C.shadowSide:C.side:M.side=C.shadowSide!==null?C.shadowSide:f[C.side],M.alphaMap=C.alphaMap,M.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,M.map=C.map,M.clipShadows=C.clipShadows,M.clippingPlanes=C.clippingPlanes,M.clipIntersection=C.clipIntersection,M.displacementMap=C.displacementMap,M.displacementScale=C.displacementScale,M.displacementBias=C.displacementBias,M.wireframeLinewidth=C.wireframeLinewidth,M.linewidth=C.linewidth,z.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const G=i.properties.get(M);G.light=z}return M}function b(A,C,z,S,M){if(A.visible===!1)return;if(A.layers.test(C.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&M===bi)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse,A.matrixWorld);const V=e.update(A),Y=A.material;if(Array.isArray(Y)){const X=V.groups;for(let H=0,B=X.length;H<B;H++){const $=X[H],ue=Y[$.materialIndex];if(ue&&ue.visible){const ae=T(A,ue,S,M);A.onBeforeShadow(i,A,C,z,V,ae,$),i.renderBufferDirect(z,null,V,ae,A,$),A.onAfterShadow(i,A,C,z,V,ae,$)}}}else if(Y.visible){const X=T(A,Y,S,M);A.onBeforeShadow(i,A,C,z,V,X,null),i.renderBufferDirect(z,null,V,X,A,null),A.onAfterShadow(i,A,C,z,V,X,null)}}const G=A.children;for(let V=0,Y=G.length;V<Y;V++)b(G[V],C,z,S,M)}function w(A){A.target.removeEventListener("dispose",w);for(const z in c){const S=c[z],M=A.target.uuid;M in S&&(S[M].dispose(),delete S[M])}}}const Ap={[cs]:ls,[us]:hs,[ds]:ps,[li]:fs,[ls]:cs,[hs]:us,[ps]:ds,[fs]:li};function Rp(i,e){function t(){let P=!1;const le=new ct;let ee=null;const fe=new ct(0,0,0,0);return{setMask:function(J){ee!==J&&!P&&(i.colorMask(J,J,J,J),ee=J)},setLocked:function(J){P=J},setClear:function(J,K,te,Re,et){et===!0&&(J*=Re,K*=Re,te*=Re),le.set(J,K,te,Re),fe.equals(le)===!1&&(i.clearColor(J,K,te,Re),fe.copy(le))},reset:function(){P=!1,ee=null,fe.set(-1,0,0,0)}}}function n(){let P=!1,le=!1,ee=null,fe=null,J=null;return{setReversed:function(K){if(le!==K){const te=e.get("EXT_clip_control");K?te.clipControlEXT(te.LOWER_LEFT_EXT,te.ZERO_TO_ONE_EXT):te.clipControlEXT(te.LOWER_LEFT_EXT,te.NEGATIVE_ONE_TO_ONE_EXT),le=K;const Re=J;J=null,this.setClear(Re)}},getReversed:function(){return le},setTest:function(K){K?Z(i.DEPTH_TEST):pe(i.DEPTH_TEST)},setMask:function(K){ee!==K&&!P&&(i.depthMask(K),ee=K)},setFunc:function(K){if(le&&(K=Ap[K]),fe!==K){switch(K){case cs:i.depthFunc(i.NEVER);break;case ls:i.depthFunc(i.ALWAYS);break;case us:i.depthFunc(i.LESS);break;case li:i.depthFunc(i.LEQUAL);break;case ds:i.depthFunc(i.EQUAL);break;case fs:i.depthFunc(i.GEQUAL);break;case hs:i.depthFunc(i.GREATER);break;case ps:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}fe=K}},setLocked:function(K){P=K},setClear:function(K){J!==K&&(le&&(K=1-K),i.clearDepth(K),J=K)},reset:function(){P=!1,ee=null,fe=null,J=null,le=!1}}}function r(){let P=!1,le=null,ee=null,fe=null,J=null,K=null,te=null,Re=null,et=null;return{setTest:function(qe){P||(qe?Z(i.STENCIL_TEST):pe(i.STENCIL_TEST))},setMask:function(qe){le!==qe&&!P&&(i.stencilMask(qe),le=qe)},setFunc:function(qe,jt,sn){(ee!==qe||fe!==jt||J!==sn)&&(i.stencilFunc(qe,jt,sn),ee=qe,fe=jt,J=sn)},setOp:function(qe,jt,sn){(K!==qe||te!==jt||Re!==sn)&&(i.stencilOp(qe,jt,sn),K=qe,te=jt,Re=sn)},setLocked:function(qe){P=qe},setClear:function(qe){et!==qe&&(i.clearStencil(qe),et=qe)},reset:function(){P=!1,le=null,ee=null,fe=null,J=null,K=null,te=null,Re=null,et=null}}}const s=new t,a=new n,o=new r,l=new WeakMap,c=new WeakMap;let d={},f={},h=new WeakMap,g=[],_=null,x=!1,p=null,u=null,E=null,T=null,b=null,w=null,A=null,C=new je(0,0,0),z=0,S=!1,M=null,D=null,G=null,V=null,Y=null;const X=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let H=!1,B=0;const $=i.getParameter(i.VERSION);$.indexOf("WebGL")!==-1?(B=parseFloat(/^WebGL (\d)/.exec($)[1]),H=B>=1):$.indexOf("OpenGL ES")!==-1&&(B=parseFloat(/^OpenGL ES (\d)/.exec($)[1]),H=B>=2);let ue=null,ae={};const de=i.getParameter(i.SCISSOR_BOX),Fe=i.getParameter(i.VIEWPORT),Le=new ct().fromArray(de),st=new ct().fromArray(Fe);function it(P,le,ee,fe){const J=new Uint8Array(4),K=i.createTexture();i.bindTexture(P,K),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let te=0;te<ee;te++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(le,0,i.RGBA,1,1,fe,0,i.RGBA,i.UNSIGNED_BYTE,J):i.texImage2D(le+te,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,J);return K}const q={};q[i.TEXTURE_2D]=it(i.TEXTURE_2D,i.TEXTURE_2D,1),q[i.TEXTURE_CUBE_MAP]=it(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[i.TEXTURE_2D_ARRAY]=it(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),q[i.TEXTURE_3D]=it(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),Z(i.DEPTH_TEST),a.setFunc(li),Ie(!1),lt(Aa),Z(i.CULL_FACE),Xe(hn);function Z(P){d[P]!==!0&&(i.enable(P),d[P]=!0)}function pe(P){d[P]!==!1&&(i.disable(P),d[P]=!1)}function Pe(P,le){return f[P]!==le?(i.bindFramebuffer(P,le),f[P]=le,P===i.DRAW_FRAMEBUFFER&&(f[i.FRAMEBUFFER]=le),P===i.FRAMEBUFFER&&(f[i.DRAW_FRAMEBUFFER]=le),!0):!1}function _e(P,le){let ee=g,fe=!1;if(P){ee=h.get(le),ee===void 0&&(ee=[],h.set(le,ee));const J=P.textures;if(ee.length!==J.length||ee[0]!==i.COLOR_ATTACHMENT0){for(let K=0,te=J.length;K<te;K++)ee[K]=i.COLOR_ATTACHMENT0+K;ee.length=J.length,fe=!0}}else ee[0]!==i.BACK&&(ee[0]=i.BACK,fe=!0);fe&&i.drawBuffers(ee)}function ke(P){return _!==P?(i.useProgram(P),_=P,!0):!1}const mt={[On]:i.FUNC_ADD,[Cc]:i.FUNC_SUBTRACT,[Pc]:i.FUNC_REVERSE_SUBTRACT};mt[Dc]=i.MIN,mt[Lc]=i.MAX;const Be={[Ic]:i.ZERO,[Uc]:i.ONE,[Fc]:i.SRC_COLOR,[as]:i.SRC_ALPHA,[Gc]:i.SRC_ALPHA_SATURATE,[Bc]:i.DST_COLOR,[zc]:i.DST_ALPHA,[Nc]:i.ONE_MINUS_SRC_COLOR,[os]:i.ONE_MINUS_SRC_ALPHA,[Vc]:i.ONE_MINUS_DST_COLOR,[Oc]:i.ONE_MINUS_DST_ALPHA,[kc]:i.CONSTANT_COLOR,[Hc]:i.ONE_MINUS_CONSTANT_COLOR,[Wc]:i.CONSTANT_ALPHA,[Xc]:i.ONE_MINUS_CONSTANT_ALPHA};function Xe(P,le,ee,fe,J,K,te,Re,et,qe){if(P===hn){x===!0&&(pe(i.BLEND),x=!1);return}if(x===!1&&(Z(i.BLEND),x=!0),P!==Rc){if(P!==p||qe!==S){if((u!==On||b!==On)&&(i.blendEquation(i.FUNC_ADD),u=On,b=On),qe)switch(P){case ai:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case pr:i.blendFunc(i.ONE,i.ONE);break;case Ra:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ca:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ve("WebGLState: Invalid blending: ",P);break}else switch(P){case ai:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case pr:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Ra:Ve("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Ca:Ve("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ve("WebGLState: Invalid blending: ",P);break}E=null,T=null,w=null,A=null,C.set(0,0,0),z=0,p=P,S=qe}return}J=J||le,K=K||ee,te=te||fe,(le!==u||J!==b)&&(i.blendEquationSeparate(mt[le],mt[J]),u=le,b=J),(ee!==E||fe!==T||K!==w||te!==A)&&(i.blendFuncSeparate(Be[ee],Be[fe],Be[K],Be[te]),E=ee,T=fe,w=K,A=te),(Re.equals(C)===!1||et!==z)&&(i.blendColor(Re.r,Re.g,Re.b,et),C.copy(Re),z=et),p=P,S=!1}function Ze(P,le){P.side===dn?pe(i.CULL_FACE):Z(i.CULL_FACE);let ee=P.side===Rt;le&&(ee=!ee),Ie(ee),P.blending===ai&&P.transparent===!1?Xe(hn):Xe(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),s.setMask(P.colorWrite);const fe=P.stencilWrite;o.setTest(fe),fe&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),ut(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?Z(i.SAMPLE_ALPHA_TO_COVERAGE):pe(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ie(P){M!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),M=P)}function lt(P){P!==Tc?(Z(i.CULL_FACE),P!==D&&(P===Aa?i.cullFace(i.BACK):P===wc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):pe(i.CULL_FACE),D=P}function R(P){P!==G&&(H&&i.lineWidth(P),G=P)}function ut(P,le,ee){P?(Z(i.POLYGON_OFFSET_FILL),(V!==le||Y!==ee)&&(i.polygonOffset(le,ee),V=le,Y=ee)):pe(i.POLYGON_OFFSET_FILL)}function We(P){P?Z(i.SCISSOR_TEST):pe(i.SCISSOR_TEST)}function Qe(P){P===void 0&&(P=i.TEXTURE0+X-1),ue!==P&&(i.activeTexture(P),ue=P)}function xe(P,le,ee){ee===void 0&&(ue===null?ee=i.TEXTURE0+X-1:ee=ue);let fe=ae[ee];fe===void 0&&(fe={type:void 0,texture:void 0},ae[ee]=fe),(fe.type!==P||fe.texture!==le)&&(ue!==ee&&(i.activeTexture(ee),ue=ee),i.bindTexture(P,le||q[P]),fe.type=P,fe.texture=le)}function y(){const P=ae[ue];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function m(){try{i.compressedTexImage2D(...arguments)}catch(P){Ve("WebGLState:",P)}}function L(){try{i.compressedTexImage3D(...arguments)}catch(P){Ve("WebGLState:",P)}}function W(){try{i.texSubImage2D(...arguments)}catch(P){Ve("WebGLState:",P)}}function j(){try{i.texSubImage3D(...arguments)}catch(P){Ve("WebGLState:",P)}}function k(){try{i.compressedTexSubImage2D(...arguments)}catch(P){Ve("WebGLState:",P)}}function Me(){try{i.compressedTexSubImage3D(...arguments)}catch(P){Ve("WebGLState:",P)}}function ne(){try{i.texStorage2D(...arguments)}catch(P){Ve("WebGLState:",P)}}function ve(){try{i.texStorage3D(...arguments)}catch(P){Ve("WebGLState:",P)}}function Ae(){try{i.texImage2D(...arguments)}catch(P){Ve("WebGLState:",P)}}function Q(){try{i.texImage3D(...arguments)}catch(P){Ve("WebGLState:",P)}}function re(P){Le.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),Le.copy(P))}function ge(P){st.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),st.copy(P))}function Se(P,le){let ee=c.get(le);ee===void 0&&(ee=new WeakMap,c.set(le,ee));let fe=ee.get(P);fe===void 0&&(fe=i.getUniformBlockIndex(le,P.name),ee.set(P,fe))}function ie(P,le){const fe=c.get(le).get(P);l.get(le)!==fe&&(i.uniformBlockBinding(le,fe,P.__bindingPointIndex),l.set(le,fe))}function Ue(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),d={},ue=null,ae={},f={},h=new WeakMap,g=[],_=null,x=!1,p=null,u=null,E=null,T=null,b=null,w=null,A=null,C=new je(0,0,0),z=0,S=!1,M=null,D=null,G=null,V=null,Y=null,Le.set(0,0,i.canvas.width,i.canvas.height),st.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:Z,disable:pe,bindFramebuffer:Pe,drawBuffers:_e,useProgram:ke,setBlending:Xe,setMaterial:Ze,setFlipSided:Ie,setCullFace:lt,setLineWidth:R,setPolygonOffset:ut,setScissorTest:We,activeTexture:Qe,bindTexture:xe,unbindTexture:y,compressedTexImage2D:m,compressedTexImage3D:L,texImage2D:Ae,texImage3D:Q,updateUBOMapping:Se,uniformBlockBinding:ie,texStorage2D:ne,texStorage3D:ve,texSubImage2D:W,texSubImage3D:j,compressedTexSubImage2D:k,compressedTexSubImage3D:Me,scissor:re,viewport:ge,reset:Ue}}function Cp(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Oe,d=new WeakMap;let f;const h=new WeakMap;let g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(y,m){return g?new OffscreenCanvas(y,m):_r("canvas")}function x(y,m,L){let W=1;const j=xe(y);if((j.width>L||j.height>L)&&(W=L/Math.max(j.width,j.height)),W<1)if(typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&y instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&y instanceof ImageBitmap||typeof VideoFrame<"u"&&y instanceof VideoFrame){const k=Math.floor(W*j.width),Me=Math.floor(W*j.height);f===void 0&&(f=_(k,Me));const ne=m?_(k,Me):f;return ne.width=k,ne.height=Me,ne.getContext("2d").drawImage(y,0,0,k,Me),Ce("WebGLRenderer: Texture has been resized from ("+j.width+"x"+j.height+") to ("+k+"x"+Me+")."),ne}else return"data"in y&&Ce("WebGLRenderer: Image in DataTexture is too big ("+j.width+"x"+j.height+")."),y;return y}function p(y){return y.generateMipmaps}function u(y){i.generateMipmap(y)}function E(y){return y.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:y.isWebGL3DRenderTarget?i.TEXTURE_3D:y.isWebGLArrayRenderTarget||y.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function T(y,m,L,W,j=!1){if(y!==null){if(i[y]!==void 0)return i[y];Ce("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+y+"'")}let k=m;if(m===i.RED&&(L===i.FLOAT&&(k=i.R32F),L===i.HALF_FLOAT&&(k=i.R16F),L===i.UNSIGNED_BYTE&&(k=i.R8)),m===i.RED_INTEGER&&(L===i.UNSIGNED_BYTE&&(k=i.R8UI),L===i.UNSIGNED_SHORT&&(k=i.R16UI),L===i.UNSIGNED_INT&&(k=i.R32UI),L===i.BYTE&&(k=i.R8I),L===i.SHORT&&(k=i.R16I),L===i.INT&&(k=i.R32I)),m===i.RG&&(L===i.FLOAT&&(k=i.RG32F),L===i.HALF_FLOAT&&(k=i.RG16F),L===i.UNSIGNED_BYTE&&(k=i.RG8)),m===i.RG_INTEGER&&(L===i.UNSIGNED_BYTE&&(k=i.RG8UI),L===i.UNSIGNED_SHORT&&(k=i.RG16UI),L===i.UNSIGNED_INT&&(k=i.RG32UI),L===i.BYTE&&(k=i.RG8I),L===i.SHORT&&(k=i.RG16I),L===i.INT&&(k=i.RG32I)),m===i.RGB_INTEGER&&(L===i.UNSIGNED_BYTE&&(k=i.RGB8UI),L===i.UNSIGNED_SHORT&&(k=i.RGB16UI),L===i.UNSIGNED_INT&&(k=i.RGB32UI),L===i.BYTE&&(k=i.RGB8I),L===i.SHORT&&(k=i.RGB16I),L===i.INT&&(k=i.RGB32I)),m===i.RGBA_INTEGER&&(L===i.UNSIGNED_BYTE&&(k=i.RGBA8UI),L===i.UNSIGNED_SHORT&&(k=i.RGBA16UI),L===i.UNSIGNED_INT&&(k=i.RGBA32UI),L===i.BYTE&&(k=i.RGBA8I),L===i.SHORT&&(k=i.RGBA16I),L===i.INT&&(k=i.RGBA32I)),m===i.RGB&&(L===i.UNSIGNED_INT_5_9_9_9_REV&&(k=i.RGB9_E5),L===i.UNSIGNED_INT_10F_11F_11F_REV&&(k=i.R11F_G11F_B10F)),m===i.RGBA){const Me=j?mr:Ge.getTransfer(W);L===i.FLOAT&&(k=i.RGBA32F),L===i.HALF_FLOAT&&(k=i.RGBA16F),L===i.UNSIGNED_BYTE&&(k=Me===Ke?i.SRGB8_ALPHA8:i.RGBA8),L===i.UNSIGNED_SHORT_4_4_4_4&&(k=i.RGBA4),L===i.UNSIGNED_SHORT_5_5_5_1&&(k=i.RGB5_A1)}return(k===i.R16F||k===i.R32F||k===i.RG16F||k===i.RG32F||k===i.RGBA16F||k===i.RGBA32F)&&e.get("EXT_color_buffer_float"),k}function b(y,m){let L;return y?m===null||m===nn||m===Ri?L=i.DEPTH24_STENCIL8:m===Jt?L=i.DEPTH32F_STENCIL8:m===Ai&&(L=i.DEPTH24_STENCIL8,Ce("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):m===null||m===nn||m===Ri?L=i.DEPTH_COMPONENT24:m===Jt?L=i.DEPTH_COMPONENT32F:m===Ai&&(L=i.DEPTH_COMPONENT16),L}function w(y,m){return p(y)===!0||y.isFramebufferTexture&&y.minFilter!==_t&&y.minFilter!==St?Math.log2(Math.max(m.width,m.height))+1:y.mipmaps!==void 0&&y.mipmaps.length>0?y.mipmaps.length:y.isCompressedTexture&&Array.isArray(y.image)?m.mipmaps.length:1}function A(y){const m=y.target;m.removeEventListener("dispose",A),z(m),m.isVideoTexture&&d.delete(m)}function C(y){const m=y.target;m.removeEventListener("dispose",C),M(m)}function z(y){const m=n.get(y);if(m.__webglInit===void 0)return;const L=y.source,W=h.get(L);if(W){const j=W[m.__cacheKey];j.usedTimes--,j.usedTimes===0&&S(y),Object.keys(W).length===0&&h.delete(L)}n.remove(y)}function S(y){const m=n.get(y);i.deleteTexture(m.__webglTexture);const L=y.source,W=h.get(L);delete W[m.__cacheKey],a.memory.textures--}function M(y){const m=n.get(y);if(y.depthTexture&&(y.depthTexture.dispose(),n.remove(y.depthTexture)),y.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(m.__webglFramebuffer[W]))for(let j=0;j<m.__webglFramebuffer[W].length;j++)i.deleteFramebuffer(m.__webglFramebuffer[W][j]);else i.deleteFramebuffer(m.__webglFramebuffer[W]);m.__webglDepthbuffer&&i.deleteRenderbuffer(m.__webglDepthbuffer[W])}else{if(Array.isArray(m.__webglFramebuffer))for(let W=0;W<m.__webglFramebuffer.length;W++)i.deleteFramebuffer(m.__webglFramebuffer[W]);else i.deleteFramebuffer(m.__webglFramebuffer);if(m.__webglDepthbuffer&&i.deleteRenderbuffer(m.__webglDepthbuffer),m.__webglMultisampledFramebuffer&&i.deleteFramebuffer(m.__webglMultisampledFramebuffer),m.__webglColorRenderbuffer)for(let W=0;W<m.__webglColorRenderbuffer.length;W++)m.__webglColorRenderbuffer[W]&&i.deleteRenderbuffer(m.__webglColorRenderbuffer[W]);m.__webglDepthRenderbuffer&&i.deleteRenderbuffer(m.__webglDepthRenderbuffer)}const L=y.textures;for(let W=0,j=L.length;W<j;W++){const k=n.get(L[W]);k.__webglTexture&&(i.deleteTexture(k.__webglTexture),a.memory.textures--),n.remove(L[W])}n.remove(y)}let D=0;function G(){D=0}function V(){const y=D;return y>=r.maxTextures&&Ce("WebGLTextures: Trying to use "+y+" texture units while this GPU supports only "+r.maxTextures),D+=1,y}function Y(y){const m=[];return m.push(y.wrapS),m.push(y.wrapT),m.push(y.wrapR||0),m.push(y.magFilter),m.push(y.minFilter),m.push(y.anisotropy),m.push(y.internalFormat),m.push(y.format),m.push(y.type),m.push(y.generateMipmaps),m.push(y.premultiplyAlpha),m.push(y.flipY),m.push(y.unpackAlignment),m.push(y.colorSpace),m.join()}function X(y,m){const L=n.get(y);if(y.isVideoTexture&&We(y),y.isRenderTargetTexture===!1&&y.isExternalTexture!==!0&&y.version>0&&L.__version!==y.version){const W=y.image;if(W===null)Ce("WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)Ce("WebGLRenderer: Texture marked for update but image is incomplete");else{q(L,y,m);return}}else y.isExternalTexture&&(L.__webglTexture=y.sourceTexture?y.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,L.__webglTexture,i.TEXTURE0+m)}function H(y,m){const L=n.get(y);if(y.isRenderTargetTexture===!1&&y.version>0&&L.__version!==y.version){q(L,y,m);return}else y.isExternalTexture&&(L.__webglTexture=y.sourceTexture?y.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,L.__webglTexture,i.TEXTURE0+m)}function B(y,m){const L=n.get(y);if(y.isRenderTargetTexture===!1&&y.version>0&&L.__version!==y.version){q(L,y,m);return}t.bindTexture(i.TEXTURE_3D,L.__webglTexture,i.TEXTURE0+m)}function $(y,m){const L=n.get(y);if(y.isCubeDepthTexture!==!0&&y.version>0&&L.__version!==y.version){Z(L,y,m);return}t.bindTexture(i.TEXTURE_CUBE_MAP,L.__webglTexture,i.TEXTURE0+m)}const ue={[_s]:i.REPEAT,[fn]:i.CLAMP_TO_EDGE,[vs]:i.MIRRORED_REPEAT},ae={[_t]:i.NEAREST,[Kc]:i.NEAREST_MIPMAP_NEAREST,[Vi]:i.NEAREST_MIPMAP_LINEAR,[St]:i.LINEAR,[Rr]:i.LINEAR_MIPMAP_NEAREST,[Vn]:i.LINEAR_MIPMAP_LINEAR},de={[Jc]:i.NEVER,[il]:i.ALWAYS,[Qc]:i.LESS,[da]:i.LEQUAL,[el]:i.EQUAL,[fa]:i.GEQUAL,[tl]:i.GREATER,[nl]:i.NOTEQUAL};function Fe(y,m){if(m.type===Jt&&e.has("OES_texture_float_linear")===!1&&(m.magFilter===St||m.magFilter===Rr||m.magFilter===Vi||m.magFilter===Vn||m.minFilter===St||m.minFilter===Rr||m.minFilter===Vi||m.minFilter===Vn)&&Ce("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(y,i.TEXTURE_WRAP_S,ue[m.wrapS]),i.texParameteri(y,i.TEXTURE_WRAP_T,ue[m.wrapT]),(y===i.TEXTURE_3D||y===i.TEXTURE_2D_ARRAY)&&i.texParameteri(y,i.TEXTURE_WRAP_R,ue[m.wrapR]),i.texParameteri(y,i.TEXTURE_MAG_FILTER,ae[m.magFilter]),i.texParameteri(y,i.TEXTURE_MIN_FILTER,ae[m.minFilter]),m.compareFunction&&(i.texParameteri(y,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(y,i.TEXTURE_COMPARE_FUNC,de[m.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(m.magFilter===_t||m.minFilter!==Vi&&m.minFilter!==Vn||m.type===Jt&&e.has("OES_texture_float_linear")===!1)return;if(m.anisotropy>1||n.get(m).__currentAnisotropy){const L=e.get("EXT_texture_filter_anisotropic");i.texParameterf(y,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(m.anisotropy,r.getMaxAnisotropy())),n.get(m).__currentAnisotropy=m.anisotropy}}}function Le(y,m){let L=!1;y.__webglInit===void 0&&(y.__webglInit=!0,m.addEventListener("dispose",A));const W=m.source;let j=h.get(W);j===void 0&&(j={},h.set(W,j));const k=Y(m);if(k!==y.__cacheKey){j[k]===void 0&&(j[k]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,L=!0),j[k].usedTimes++;const Me=j[y.__cacheKey];Me!==void 0&&(j[y.__cacheKey].usedTimes--,Me.usedTimes===0&&S(m)),y.__cacheKey=k,y.__webglTexture=j[k].texture}return L}function st(y,m,L){return Math.floor(Math.floor(y/L)/m)}function it(y,m,L,W){const k=y.updateRanges;if(k.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,m.width,m.height,L,W,m.data);else{k.sort((Q,re)=>Q.start-re.start);let Me=0;for(let Q=1;Q<k.length;Q++){const re=k[Me],ge=k[Q],Se=re.start+re.count,ie=st(ge.start,m.width,4),Ue=st(re.start,m.width,4);ge.start<=Se+1&&ie===Ue&&st(ge.start+ge.count-1,m.width,4)===ie?re.count=Math.max(re.count,ge.start+ge.count-re.start):(++Me,k[Me]=ge)}k.length=Me+1;const ne=i.getParameter(i.UNPACK_ROW_LENGTH),ve=i.getParameter(i.UNPACK_SKIP_PIXELS),Ae=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,m.width);for(let Q=0,re=k.length;Q<re;Q++){const ge=k[Q],Se=Math.floor(ge.start/4),ie=Math.ceil(ge.count/4),Ue=Se%m.width,P=Math.floor(Se/m.width),le=ie,ee=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Ue),i.pixelStorei(i.UNPACK_SKIP_ROWS,P),t.texSubImage2D(i.TEXTURE_2D,0,Ue,P,le,ee,L,W,m.data)}y.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,ne),i.pixelStorei(i.UNPACK_SKIP_PIXELS,ve),i.pixelStorei(i.UNPACK_SKIP_ROWS,Ae)}}function q(y,m,L){let W=i.TEXTURE_2D;(m.isDataArrayTexture||m.isCompressedArrayTexture)&&(W=i.TEXTURE_2D_ARRAY),m.isData3DTexture&&(W=i.TEXTURE_3D);const j=Le(y,m),k=m.source;t.bindTexture(W,y.__webglTexture,i.TEXTURE0+L);const Me=n.get(k);if(k.version!==Me.__version||j===!0){t.activeTexture(i.TEXTURE0+L);const ne=Ge.getPrimaries(Ge.workingColorSpace),ve=m.colorSpace===Tn?null:Ge.getPrimaries(m.colorSpace),Ae=m.colorSpace===Tn||ne===ve?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,m.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,m.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ae);let Q=x(m.image,!1,r.maxTextureSize);Q=Qe(m,Q);const re=s.convert(m.format,m.colorSpace),ge=s.convert(m.type);let Se=T(m.internalFormat,re,ge,m.colorSpace,m.isVideoTexture);Fe(W,m);let ie;const Ue=m.mipmaps,P=m.isVideoTexture!==!0,le=Me.__version===void 0||j===!0,ee=k.dataReady,fe=w(m,Q);if(m.isDepthTexture)Se=b(m.format===Gn,m.type),le&&(P?t.texStorage2D(i.TEXTURE_2D,1,Se,Q.width,Q.height):t.texImage2D(i.TEXTURE_2D,0,Se,Q.width,Q.height,0,re,ge,null));else if(m.isDataTexture)if(Ue.length>0){P&&le&&t.texStorage2D(i.TEXTURE_2D,fe,Se,Ue[0].width,Ue[0].height);for(let J=0,K=Ue.length;J<K;J++)ie=Ue[J],P?ee&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,ie.width,ie.height,re,ge,ie.data):t.texImage2D(i.TEXTURE_2D,J,Se,ie.width,ie.height,0,re,ge,ie.data);m.generateMipmaps=!1}else P?(le&&t.texStorage2D(i.TEXTURE_2D,fe,Se,Q.width,Q.height),ee&&it(m,Q,re,ge)):t.texImage2D(i.TEXTURE_2D,0,Se,Q.width,Q.height,0,re,ge,Q.data);else if(m.isCompressedTexture)if(m.isCompressedArrayTexture){P&&le&&t.texStorage3D(i.TEXTURE_2D_ARRAY,fe,Se,Ue[0].width,Ue[0].height,Q.depth);for(let J=0,K=Ue.length;J<K;J++)if(ie=Ue[J],m.format!==qt)if(re!==null)if(P){if(ee)if(m.layerUpdates.size>0){const te=to(ie.width,ie.height,m.format,m.type);for(const Re of m.layerUpdates){const et=ie.data.subarray(Re*te/ie.data.BYTES_PER_ELEMENT,(Re+1)*te/ie.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,Re,ie.width,ie.height,1,re,et)}m.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,ie.width,ie.height,Q.depth,re,ie.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,J,Se,ie.width,ie.height,Q.depth,0,ie.data,0,0);else Ce("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else P?ee&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,ie.width,ie.height,Q.depth,re,ge,ie.data):t.texImage3D(i.TEXTURE_2D_ARRAY,J,Se,ie.width,ie.height,Q.depth,0,re,ge,ie.data)}else{P&&le&&t.texStorage2D(i.TEXTURE_2D,fe,Se,Ue[0].width,Ue[0].height);for(let J=0,K=Ue.length;J<K;J++)ie=Ue[J],m.format!==qt?re!==null?P?ee&&t.compressedTexSubImage2D(i.TEXTURE_2D,J,0,0,ie.width,ie.height,re,ie.data):t.compressedTexImage2D(i.TEXTURE_2D,J,Se,ie.width,ie.height,0,ie.data):Ce("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):P?ee&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,ie.width,ie.height,re,ge,ie.data):t.texImage2D(i.TEXTURE_2D,J,Se,ie.width,ie.height,0,re,ge,ie.data)}else if(m.isDataArrayTexture)if(P){if(le&&t.texStorage3D(i.TEXTURE_2D_ARRAY,fe,Se,Q.width,Q.height,Q.depth),ee)if(m.layerUpdates.size>0){const J=to(Q.width,Q.height,m.format,m.type);for(const K of m.layerUpdates){const te=Q.data.subarray(K*J/Q.data.BYTES_PER_ELEMENT,(K+1)*J/Q.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,K,Q.width,Q.height,1,re,ge,te)}m.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,re,ge,Q.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Se,Q.width,Q.height,Q.depth,0,re,ge,Q.data);else if(m.isData3DTexture)P?(le&&t.texStorage3D(i.TEXTURE_3D,fe,Se,Q.width,Q.height,Q.depth),ee&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,re,ge,Q.data)):t.texImage3D(i.TEXTURE_3D,0,Se,Q.width,Q.height,Q.depth,0,re,ge,Q.data);else if(m.isFramebufferTexture){if(le)if(P)t.texStorage2D(i.TEXTURE_2D,fe,Se,Q.width,Q.height);else{let J=Q.width,K=Q.height;for(let te=0;te<fe;te++)t.texImage2D(i.TEXTURE_2D,te,Se,J,K,0,re,ge,null),J>>=1,K>>=1}}else if(Ue.length>0){if(P&&le){const J=xe(Ue[0]);t.texStorage2D(i.TEXTURE_2D,fe,Se,J.width,J.height)}for(let J=0,K=Ue.length;J<K;J++)ie=Ue[J],P?ee&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,re,ge,ie):t.texImage2D(i.TEXTURE_2D,J,Se,re,ge,ie);m.generateMipmaps=!1}else if(P){if(le){const J=xe(Q);t.texStorage2D(i.TEXTURE_2D,fe,Se,J.width,J.height)}ee&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,re,ge,Q)}else t.texImage2D(i.TEXTURE_2D,0,Se,re,ge,Q);p(m)&&u(W),Me.__version=k.version,m.onUpdate&&m.onUpdate(m)}y.__version=m.version}function Z(y,m,L){if(m.image.length!==6)return;const W=Le(y,m),j=m.source;t.bindTexture(i.TEXTURE_CUBE_MAP,y.__webglTexture,i.TEXTURE0+L);const k=n.get(j);if(j.version!==k.__version||W===!0){t.activeTexture(i.TEXTURE0+L);const Me=Ge.getPrimaries(Ge.workingColorSpace),ne=m.colorSpace===Tn?null:Ge.getPrimaries(m.colorSpace),ve=m.colorSpace===Tn||Me===ne?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,m.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,m.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ve);const Ae=m.isCompressedTexture||m.image[0].isCompressedTexture,Q=m.image[0]&&m.image[0].isDataTexture,re=[];for(let K=0;K<6;K++)!Ae&&!Q?re[K]=x(m.image[K],!0,r.maxCubemapSize):re[K]=Q?m.image[K].image:m.image[K],re[K]=Qe(m,re[K]);const ge=re[0],Se=s.convert(m.format,m.colorSpace),ie=s.convert(m.type),Ue=T(m.internalFormat,Se,ie,m.colorSpace),P=m.isVideoTexture!==!0,le=k.__version===void 0||W===!0,ee=j.dataReady;let fe=w(m,ge);Fe(i.TEXTURE_CUBE_MAP,m);let J;if(Ae){P&&le&&t.texStorage2D(i.TEXTURE_CUBE_MAP,fe,Ue,ge.width,ge.height);for(let K=0;K<6;K++){J=re[K].mipmaps;for(let te=0;te<J.length;te++){const Re=J[te];m.format!==qt?Se!==null?P?ee&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,te,0,0,Re.width,Re.height,Se,Re.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,te,Ue,Re.width,Re.height,0,Re.data):Ce("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):P?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,te,0,0,Re.width,Re.height,Se,ie,Re.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,te,Ue,Re.width,Re.height,0,Se,ie,Re.data)}}}else{if(J=m.mipmaps,P&&le){J.length>0&&fe++;const K=xe(re[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,fe,Ue,K.width,K.height)}for(let K=0;K<6;K++)if(Q){P?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,re[K].width,re[K].height,Se,ie,re[K].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ue,re[K].width,re[K].height,0,Se,ie,re[K].data);for(let te=0;te<J.length;te++){const et=J[te].image[K].image;P?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,te+1,0,0,et.width,et.height,Se,ie,et.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,te+1,Ue,et.width,et.height,0,Se,ie,et.data)}}else{P?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,Se,ie,re[K]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ue,Se,ie,re[K]);for(let te=0;te<J.length;te++){const Re=J[te];P?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,te+1,0,0,Se,ie,Re.image[K]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,te+1,Ue,Se,ie,Re.image[K])}}}p(m)&&u(i.TEXTURE_CUBE_MAP),k.__version=j.version,m.onUpdate&&m.onUpdate(m)}y.__version=m.version}function pe(y,m,L,W,j,k){const Me=s.convert(L.format,L.colorSpace),ne=s.convert(L.type),ve=T(L.internalFormat,Me,ne,L.colorSpace),Ae=n.get(m),Q=n.get(L);if(Q.__renderTarget=m,!Ae.__hasExternalTextures){const re=Math.max(1,m.width>>k),ge=Math.max(1,m.height>>k);j===i.TEXTURE_3D||j===i.TEXTURE_2D_ARRAY?t.texImage3D(j,k,ve,re,ge,m.depth,0,Me,ne,null):t.texImage2D(j,k,ve,re,ge,0,Me,ne,null)}t.bindFramebuffer(i.FRAMEBUFFER,y),ut(m)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,W,j,Q.__webglTexture,0,R(m)):(j===i.TEXTURE_2D||j>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&j<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,W,j,Q.__webglTexture,k),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Pe(y,m,L){if(i.bindRenderbuffer(i.RENDERBUFFER,y),m.depthBuffer){const W=m.depthTexture,j=W&&W.isDepthTexture?W.type:null,k=b(m.stencilBuffer,j),Me=m.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;ut(m)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,R(m),k,m.width,m.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,R(m),k,m.width,m.height):i.renderbufferStorage(i.RENDERBUFFER,k,m.width,m.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Me,i.RENDERBUFFER,y)}else{const W=m.textures;for(let j=0;j<W.length;j++){const k=W[j],Me=s.convert(k.format,k.colorSpace),ne=s.convert(k.type),ve=T(k.internalFormat,Me,ne,k.colorSpace);ut(m)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,R(m),ve,m.width,m.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,R(m),ve,m.width,m.height):i.renderbufferStorage(i.RENDERBUFFER,ve,m.width,m.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function _e(y,m,L){const W=m.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,y),!(m.depthTexture&&m.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const j=n.get(m.depthTexture);if(j.__renderTarget=m,(!j.__webglTexture||m.depthTexture.image.width!==m.width||m.depthTexture.image.height!==m.height)&&(m.depthTexture.image.width=m.width,m.depthTexture.image.height=m.height,m.depthTexture.needsUpdate=!0),W){if(j.__webglInit===void 0&&(j.__webglInit=!0,m.depthTexture.addEventListener("dispose",A)),j.__webglTexture===void 0){j.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,j.__webglTexture),Fe(i.TEXTURE_CUBE_MAP,m.depthTexture);const Ae=s.convert(m.depthTexture.format),Q=s.convert(m.depthTexture.type);let re;m.depthTexture.format===vn?re=i.DEPTH_COMPONENT24:m.depthTexture.format===Gn&&(re=i.DEPTH24_STENCIL8);for(let ge=0;ge<6;ge++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,re,m.width,m.height,0,Ae,Q,null)}}else X(m.depthTexture,0);const k=j.__webglTexture,Me=R(m),ne=W?i.TEXTURE_CUBE_MAP_POSITIVE_X+L:i.TEXTURE_2D,ve=m.depthTexture.format===Gn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(m.depthTexture.format===vn)ut(m)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ve,ne,k,0,Me):i.framebufferTexture2D(i.FRAMEBUFFER,ve,ne,k,0);else if(m.depthTexture.format===Gn)ut(m)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ve,ne,k,0,Me):i.framebufferTexture2D(i.FRAMEBUFFER,ve,ne,k,0);else throw new Error("Unknown depthTexture format")}function ke(y){const m=n.get(y),L=y.isWebGLCubeRenderTarget===!0;if(m.__boundDepthTexture!==y.depthTexture){const W=y.depthTexture;if(m.__depthDisposeCallback&&m.__depthDisposeCallback(),W){const j=()=>{delete m.__boundDepthTexture,delete m.__depthDisposeCallback,W.removeEventListener("dispose",j)};W.addEventListener("dispose",j),m.__depthDisposeCallback=j}m.__boundDepthTexture=W}if(y.depthTexture&&!m.__autoAllocateDepthBuffer)if(L)for(let W=0;W<6;W++)_e(m.__webglFramebuffer[W],y,W);else{const W=y.texture.mipmaps;W&&W.length>0?_e(m.__webglFramebuffer[0],y,0):_e(m.__webglFramebuffer,y,0)}else if(L){m.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(t.bindFramebuffer(i.FRAMEBUFFER,m.__webglFramebuffer[W]),m.__webglDepthbuffer[W]===void 0)m.__webglDepthbuffer[W]=i.createRenderbuffer(),Pe(m.__webglDepthbuffer[W],y,!1);else{const j=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,k=m.__webglDepthbuffer[W];i.bindRenderbuffer(i.RENDERBUFFER,k),i.framebufferRenderbuffer(i.FRAMEBUFFER,j,i.RENDERBUFFER,k)}}else{const W=y.texture.mipmaps;if(W&&W.length>0?t.bindFramebuffer(i.FRAMEBUFFER,m.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,m.__webglFramebuffer),m.__webglDepthbuffer===void 0)m.__webglDepthbuffer=i.createRenderbuffer(),Pe(m.__webglDepthbuffer,y,!1);else{const j=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,k=m.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,k),i.framebufferRenderbuffer(i.FRAMEBUFFER,j,i.RENDERBUFFER,k)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function mt(y,m,L){const W=n.get(y);m!==void 0&&pe(W.__webglFramebuffer,y,y.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),L!==void 0&&ke(y)}function Be(y){const m=y.texture,L=n.get(y),W=n.get(m);y.addEventListener("dispose",C);const j=y.textures,k=y.isWebGLCubeRenderTarget===!0,Me=j.length>1;if(Me||(W.__webglTexture===void 0&&(W.__webglTexture=i.createTexture()),W.__version=m.version,a.memory.textures++),k){L.__webglFramebuffer=[];for(let ne=0;ne<6;ne++)if(m.mipmaps&&m.mipmaps.length>0){L.__webglFramebuffer[ne]=[];for(let ve=0;ve<m.mipmaps.length;ve++)L.__webglFramebuffer[ne][ve]=i.createFramebuffer()}else L.__webglFramebuffer[ne]=i.createFramebuffer()}else{if(m.mipmaps&&m.mipmaps.length>0){L.__webglFramebuffer=[];for(let ne=0;ne<m.mipmaps.length;ne++)L.__webglFramebuffer[ne]=i.createFramebuffer()}else L.__webglFramebuffer=i.createFramebuffer();if(Me)for(let ne=0,ve=j.length;ne<ve;ne++){const Ae=n.get(j[ne]);Ae.__webglTexture===void 0&&(Ae.__webglTexture=i.createTexture(),a.memory.textures++)}if(y.samples>0&&ut(y)===!1){L.__webglMultisampledFramebuffer=i.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let ne=0;ne<j.length;ne++){const ve=j[ne];L.__webglColorRenderbuffer[ne]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,L.__webglColorRenderbuffer[ne]);const Ae=s.convert(ve.format,ve.colorSpace),Q=s.convert(ve.type),re=T(ve.internalFormat,Ae,Q,ve.colorSpace,y.isXRRenderTarget===!0),ge=R(y);i.renderbufferStorageMultisample(i.RENDERBUFFER,ge,re,y.width,y.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ne,i.RENDERBUFFER,L.__webglColorRenderbuffer[ne])}i.bindRenderbuffer(i.RENDERBUFFER,null),y.depthBuffer&&(L.__webglDepthRenderbuffer=i.createRenderbuffer(),Pe(L.__webglDepthRenderbuffer,y,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(k){t.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture),Fe(i.TEXTURE_CUBE_MAP,m);for(let ne=0;ne<6;ne++)if(m.mipmaps&&m.mipmaps.length>0)for(let ve=0;ve<m.mipmaps.length;ve++)pe(L.__webglFramebuffer[ne][ve],y,m,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ve);else pe(L.__webglFramebuffer[ne],y,m,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0);p(m)&&u(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Me){for(let ne=0,ve=j.length;ne<ve;ne++){const Ae=j[ne],Q=n.get(Ae);let re=i.TEXTURE_2D;(y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(re=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(re,Q.__webglTexture),Fe(re,Ae),pe(L.__webglFramebuffer,y,Ae,i.COLOR_ATTACHMENT0+ne,re,0),p(Ae)&&u(re)}t.unbindTexture()}else{let ne=i.TEXTURE_2D;if((y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(ne=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ne,W.__webglTexture),Fe(ne,m),m.mipmaps&&m.mipmaps.length>0)for(let ve=0;ve<m.mipmaps.length;ve++)pe(L.__webglFramebuffer[ve],y,m,i.COLOR_ATTACHMENT0,ne,ve);else pe(L.__webglFramebuffer,y,m,i.COLOR_ATTACHMENT0,ne,0);p(m)&&u(ne),t.unbindTexture()}y.depthBuffer&&ke(y)}function Xe(y){const m=y.textures;for(let L=0,W=m.length;L<W;L++){const j=m[L];if(p(j)){const k=E(y),Me=n.get(j).__webglTexture;t.bindTexture(k,Me),u(k),t.unbindTexture()}}}const Ze=[],Ie=[];function lt(y){if(y.samples>0){if(ut(y)===!1){const m=y.textures,L=y.width,W=y.height;let j=i.COLOR_BUFFER_BIT;const k=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Me=n.get(y),ne=m.length>1;if(ne)for(let Ae=0;Ae<m.length;Ae++)t.bindFramebuffer(i.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ae,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Me.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ae,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Me.__webglMultisampledFramebuffer);const ve=y.texture.mipmaps;ve&&ve.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Me.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Me.__webglFramebuffer);for(let Ae=0;Ae<m.length;Ae++){if(y.resolveDepthBuffer&&(y.depthBuffer&&(j|=i.DEPTH_BUFFER_BIT),y.stencilBuffer&&y.resolveStencilBuffer&&(j|=i.STENCIL_BUFFER_BIT)),ne){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Me.__webglColorRenderbuffer[Ae]);const Q=n.get(m[Ae]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Q,0)}i.blitFramebuffer(0,0,L,W,0,0,L,W,j,i.NEAREST),l===!0&&(Ze.length=0,Ie.length=0,Ze.push(i.COLOR_ATTACHMENT0+Ae),y.depthBuffer&&y.resolveDepthBuffer===!1&&(Ze.push(k),Ie.push(k),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Ie)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Ze))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ne)for(let Ae=0;Ae<m.length;Ae++){t.bindFramebuffer(i.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ae,i.RENDERBUFFER,Me.__webglColorRenderbuffer[Ae]);const Q=n.get(m[Ae]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Me.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ae,i.TEXTURE_2D,Q,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Me.__webglMultisampledFramebuffer)}else if(y.depthBuffer&&y.resolveDepthBuffer===!1&&l){const m=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[m])}}}function R(y){return Math.min(r.maxSamples,y.samples)}function ut(y){const m=n.get(y);return y.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&m.__useRenderToTexture!==!1}function We(y){const m=a.render.frame;d.get(y)!==m&&(d.set(y,m),y.update())}function Qe(y,m){const L=y.colorSpace,W=y.format,j=y.type;return y.isCompressedTexture===!0||y.isVideoTexture===!0||L!==fi&&L!==Tn&&(Ge.getTransfer(L)===Ke?(W!==qt||j!==Ot)&&Ce("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ve("WebGLTextures: Unsupported texture color space:",L)),m}function xe(y){return typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement?(c.width=y.naturalWidth||y.width,c.height=y.naturalHeight||y.height):typeof VideoFrame<"u"&&y instanceof VideoFrame?(c.width=y.displayWidth,c.height=y.displayHeight):(c.width=y.width,c.height=y.height),c}this.allocateTextureUnit=V,this.resetTextureUnits=G,this.setTexture2D=X,this.setTexture2DArray=H,this.setTexture3D=B,this.setTextureCube=$,this.rebindTextures=mt,this.setupRenderTarget=Be,this.updateRenderTargetMipmap=Xe,this.updateMultisampleRenderTarget=lt,this.setupDepthRenderbuffer=ke,this.setupFrameBufferTexture=pe,this.useMultisampledRTT=ut,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Pp(i,e){function t(n,r=Tn){let s;const a=Ge.getTransfer(r);if(n===Ot)return i.UNSIGNED_BYTE;if(n===aa)return i.UNSIGNED_SHORT_4_4_4_4;if(n===oa)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Xo)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===qo)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Ho)return i.BYTE;if(n===Wo)return i.SHORT;if(n===Ai)return i.UNSIGNED_SHORT;if(n===sa)return i.INT;if(n===nn)return i.UNSIGNED_INT;if(n===Jt)return i.FLOAT;if(n===_n)return i.HALF_FLOAT;if(n===Yo)return i.ALPHA;if(n===Ko)return i.RGB;if(n===qt)return i.RGBA;if(n===vn)return i.DEPTH_COMPONENT;if(n===Gn)return i.DEPTH_STENCIL;if(n===jo)return i.RED;if(n===ca)return i.RED_INTEGER;if(n===di)return i.RG;if(n===la)return i.RG_INTEGER;if(n===ua)return i.RGBA_INTEGER;if(n===lr||n===ur||n===dr||n===fr)if(a===Ke)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===lr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ur)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===dr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===fr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===lr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ur)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===dr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===fr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===xs||n===Ss||n===Ms||n===ys)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===xs)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ss)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ms)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ys)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Es||n===bs||n===Ts||n===ws||n===As||n===Rs||n===Cs)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Es||n===bs)return a===Ke?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Ts)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===ws)return s.COMPRESSED_R11_EAC;if(n===As)return s.COMPRESSED_SIGNED_R11_EAC;if(n===Rs)return s.COMPRESSED_RG11_EAC;if(n===Cs)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Ps||n===Ds||n===Ls||n===Is||n===Us||n===Fs||n===Ns||n===zs||n===Os||n===Bs||n===Vs||n===Gs||n===ks||n===Hs)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Ps)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ds)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Ls)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Is)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Us)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Fs)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ns)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===zs)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Os)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Bs)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Vs)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Gs)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ks)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Hs)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ws||n===Xs||n===qs)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Ws)return a===Ke?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Xs)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===qs)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ys||n===Ks||n===js||n===$s)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===Ys)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Ks)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===js)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===$s)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ri?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Dp=`
void main() {
...
\r
    gl_FragColor = vec4(v_color, 1.0);\r
}`;function pc(){return new nt({name:"Particles",userData:{description:`
            ...
            `},uniforms:{...ft,u_pointSize:{value:5}},vertexShader:dm,fragmentShader:fm,transparent:!0,depthWrite:!1,blending:pr})}const hm=`precision mediump float;\r
\r
varying vec3 v_position;\r
varying vec3 v_normal;\r
\r
...
void main() {\r
    ...
    gl_FragColor = vec4(vec3(n), 1.0);\r
}`;function Mm(){return new nt({name:"Mix Worley with Simplex",userData:{description:`
            ...
            `},uniforms:{...ft},vertexShader:xm,fragmentShader:Sm})}const ym=`precision mediump float;\r
\r
varying vec3 v_position;\r
varying vec3 v_normal;\r
\r
...
\r
    gl_FragColor = vec4(vec3(color) , 1.0);\r
                ...
                <a href="https://github.com/JustRaika/Men5/blob/main/src/shaders/materials/11_noise_deform/fragment.glsl" target="_blank">Fragment Shader</a>
                 & 
                <a href="https://github.com/JustRaika/Men5/tree/main/src/shaders/chunks" target="_blank">Noise Chunks</a>
            `},uniforms:{...ft},vertexShader:ym,fragmentShader:Em})}const Tm=`precision mediump float;\r
\r
...
`;function Am(){return new nt({name:"Glow",userData:{description:`
            ...
            `},uniforms:{...ft},vertexShader:Tm,fragmentShader:wm,transparent:!0,blending:pr,depthWrite:!1})}const Rm=`precision mediump float;\r
\r
...
\r
    gl_FragColor = vec4(vec3(color), 1.0);\r
            ...
            `},uniforms:{...ft},vertexShader:Rm,fragmentShader:Cm})}const Dm=`precision mediump float;\r
\r
varying vec3 v_position;\r
varying vec3 v_normal;\r
...
\r
    gl_FragColor = vec4(col, alpha);\r
            ...
            `},uniforms:{...ft},vertexShader:Um,fragmentShader:Fm,transparent:!0,depthWrite:!1})}const na=[jp(),Jp(),tm(),rm(),om(),um(),pc(),mm(),vm(),Mm(),bm(),Pm(),Am(),Im(),Nm()];function zm(i,e,t=new ga(1,32,32)){return e.map((n,r)=>{const s=new Kt(t,n);return s.name=n.name,s.description=n.userData.description,s.position.x=r*i,s.userData={title:n.name,description:`This sphere demonstrates the ${n.name} shader.`},s})}function Om(i,e){const t=new kn;t.name="Sphere Labels";const n=-1.4;return e.map((r,s)=>{const a=document.createElement("p");a.textContent=r.name;const o=new Gp(a);o.name=r.name,o.position.set(s*i,n,0),t.add(o)}),t}function Bm(i,e){const t=new Vt,n=new Float32Array(e*3);for(let s=0;s<e;s++){const a=Math.random()*3*Math.PI,o=Math.acos(2*Math.random()-1),l=Math.sin(o)*Math.cos(a),c=Math.sin(o)*Math.sin(a),d=Math.cos(o);n[s*3+0]=l*1.5,n[s*3+1]=c*1.25,n[s*3+2]=d*1.5}return t.setAttribute("position",new Yt(n,3)),new Nl(t,i)}const mn={raycaster:new Hl,hits:[],hit:!1,getMouseRay(i,e,t,n=!1){const r=new Oe(i.x/e.clientWidth*2-1,-(i.y/e.clientHeight)*2+1);this.raycaster.setFromCamera(r,t)},getIntersects(i,e,t,n,r=!1){return this.getMouseRay(i,e,t),this.hits=this.raycaster.intersectObjects(n.children,r),this.hits[0]?.object?.name==="Background"&&(this.hits=[]),this.hits.length>0?this.hit=!0:this.hit=!1,this.hits}},vr={speed:.01,object:null,rotating:!1,initialRotation:0,startPos:0,start(i){mn.hits[0].object.userData.group?this.object=mn.hits[0].object.userData.group:this.object=mn.hits[0].object,this.initialRotation=this.object.rotation.y,this.startPos=i.x,this.rotating=!0},update(i){let e=i.x-this.startPos;this.object.rotation.y=this.initialRotation+e*this.speed}};function Vm(i,e,t){const r=new rn((i.y/e.clientHeight-.5)*.05,(i.x/e.clientWidth-.5)*.05,0,"XYZ");t.quaternion.setFromEuler(r)}const Di={paused:!1,pausedAt:0,offset:0,update(i){this.paused||(ft.u_time.value=i.getElapsedTime()-this.offset)},pause(i){this.paused=!0,this.pausedAt=i.getElapsedTime()},resume(i){this.paused&&(this.offset+=i.getElapsedTime()-this.pausedAt),this.paused=!1}};function Gm(){return/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||window.matchMedia("(max-width: 768px)").matches}const mc={CLICK_TIME:.2,CLICK_DIST:5,isDown:!1,startPos:new Oe,startTime:0,start(i,e){this.isDown=!0,this.startTime=i.getElapsedTime(),this.startPos.set(e.clientX,e.clientY)},stop(i,e){this.isDown=!1;const t=i.getElapsedTime()-this.startTime,n=this.startPos.distanceTo(new Oe(e.clientX,e.clientY));return t<this.CLICK_TIME&&n<this.CLICK_DIST}},km=`// This file include function that are used cross diffrent noises. So they can be included in the same file without glashing.\r
\r
...
`,Km=`// Cellular noise ("Worley noise") in 3D in GLSL.
...
}`;function Zm(){Te.noisebase=km,Te.perlin3D=Hm,Te.perlin4D=Wm,Te.simplex3D=Xm,Te.simplex3DGradient=qm,Te.simplex4D=Ym,Te.worley3D=Km,Te.fbm=jm,Te.curl=$m}const Jm=`precision mediump float;\r
\r
varying vec3 v_position;\r
varying vec3 v_normal;\r
\r
...
`;function e0(){return new nt({name:"BackgroundStars",uniforms:{...ft},vertexShader:Jm,fragmentShader:Qm,depthWrite:!1,depthTest:!1})}function t0(i){const e=new zi(2,2),t=e0(),n=new Kt(e,t);n.name="Background",n.frustumCulled=!1,n.renderOrder=-1,i.add(n)}function n0({timeManager:i,clock:e}){const t=document.getElementById("mobile-overlay");if(Gm()){t?.classList.add("active"),document.body.classList.add("no-scroll"),i?.pause(e);return}}function i0({timeManager:i,clock:e}){const t=document.getElementById("about-btn"),n=document.getElementById("about-overlay"),r=document.getElementById("about-close");if(!t||!n||!r)return;t.addEventListener("click",a=>{a.preventDefault(),n.classList.add("active"),document.body.classList.add("ui-open"),i?.pause(e),_a()}),r.addEventListener("click",s),n.addEventListener("click",a=>{a.target===n&&s()}),window.addEventListener("keydown",a=>{a.key==="Escape"&&n.classList.contains("active")&&s()});function s(){n.classList.remove("active"),document.body.classList.remove("ui-open"),i?.resume(e)}}let It=null,xr=null;const Po={x:-400,y:-180};function r0(){It=document.createElement("div"),It.className="sphere-info",It.innerHTML=`
          <button class="sphere-info-close">✕</button>
          <h3></h3>
          <div></div>
     `,document.body.appendChild(It),It.querySelector(".sphere-info-close").addEventListener("click",_a)}function Do(i){xr=i,It.querySelector("h3").textContent=i.name,It.querySelector("div").innerHTML=i.description?i.description:`
     ...
     `,It.classList.add("active")}function _a(){xr=null,It.classList.remove("active"),It.addEventListener("transitionend",()=>{It.style.removeProperty("transform")},{once:!0})}function s0(i){if(!xr||!It.classList.contains("active"))return;const e=xr.position.clone();e.project(i);const t=(e.x*.5+.5)*window.innerWidth+Po.x,n=(-e.y*.5+.5)*window.innerHeight+Po.y;It.style.transform=`translate(${t}px, ${n}px)`}const Xt=document.querySelector("#three");let ci,gn,Sr,An,va,ss=[],ia=3.5,wi=new Oe,gc=!0;function a0(){if(!Xt)return console.error("Canvas not found!");({scene:ci,camera:gn}=Xp(Xt)),Sr=Hp(Xt),Zm();const i=new kn;i.name="Spheres",ss=zm(ia,na),ss.forEach(t=>i.add(t));let e=ss.find(t=>t.name==="Particles");if(e){let t=new kn;t.name=e.name,t.description=e.description,t.position.x=e.position.x,e.position.x=0,e.userData.group=t,t.add(e);const n=pc(),r=Bm(n,800);r.userData.group=t,r.name=e.name,r.description=e.description,t.add(r),i.remove(e),i.add(t)}va=Wp(Xt),i.add(Om(ia,na)),ci.add(i),An=new kl,n0({timeManager:Di,clock:An}),i0({timeManager:Di,clock:An}),r0(),qp(Xt,{onResize:Lo,onScroll:Io,onMouseMove:c0,onClickStart:l0,onClickEnd:u0,setMouseOnCanvas:t=>gc=t}),Lo(),Io(),Sr.setAnimationLoop(o0),t0(ci)}function o0(){Di.update(An),s0(gn),va.render(ci,gn),Sr.render(ci,gn)}function Lo(){const i=Xt.clientWidth,e=Xt.clientHeight;Sr.setSize(i,e,!1),gn.aspect=i/e,gn.updateProjectionMatrix(),ft.u_resolution.value.set(i,e),va.setSize(i,e)}function Io(){const i=window.scrollY;ft.u_scroll.value=i;const e=(na.length-1)*ia,t=i/(document.documentElement.scrollHeight-window.innerHeight);gn.position.x=t*e}function c0(i){wi.set(i.clientX,i.clientY),ft.u_mouse.value.set(i.clientX/Xt.clientWidth*2-1,-(i.clientY/Xt.clientHeight)*2+1),vr.rotating&&mn.hit&&vr.update(wi),Vm(wi,Xt,gn)}function l0(i){gc&&(mn.getIntersects(wi,Xt,gn,ci,!0),_a(),mn.hit?(mc.start(An,i),vr.start(wi)):Di.pause(An))}function u0(i){vr.rotating=!1,Di.resume(An),mc.stop(An,i)&&(mn.hits[0].object.userData.group?Do(mn.hits[0].object.userData.group):Do(mn.hits[0].object))}a0();
